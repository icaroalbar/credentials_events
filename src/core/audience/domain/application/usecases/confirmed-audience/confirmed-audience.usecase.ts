...
import { ConfirmedAudienceOutputDTO } from "./confirmed-audience.dto";

export class ConfirmedAudienceUseCase {
  constructor(private readonly audienceRepository: AudienceGateway) {}

  async execute(id: string): Promise<ConfirmedAudienceOutputDTO> {
